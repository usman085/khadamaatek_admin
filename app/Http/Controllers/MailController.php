...
class MailController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $template->save();
        $request->session()->flash('message', translateMessage('messages.emailTemCreated'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $template->content = $request->input('content');
        $template->save();
        $request->session()->flash('message',translateMessage('messages.emailTemUpdated'));
        return redirect()->route('mail.index');
    }
    ...
    public function destroy($id, Request $request)
    {
        ...
        $request->session()->flash('message', translateMessage('messages.emailTemDelete'));
        return redirect()->route('mail.index');
    }
    ...
    public function send($id, Request $request){
        ...
        $request->session()->flash('message', translateMessage('messages.emailTemSend'));
        return redirect()->route('mail.index');
    }
}
