    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('edit', function ($query) {
                return '<a href="' . route('groups.edit', $query->id) . '" class="btn btn-primary">'.translateMessage('common.edit').'</a>';
            })
            ->addColumn('delete', function ($query) {
                return '<form class="form" action="' . route('groups.destroy', $query->id) . '" 
               method="POST"> 
                <input type="hidden" name="_method" value="DELETE"> 
                <input type="hidden" name="_token" value="' . csrf_token() . '"> 
                <button type="submit" class="btn btn-danger ">'.translateMessage('common.delete').'</button> 
                </form>
                <div id="confirmBox">
