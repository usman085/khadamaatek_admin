<template>
  <v-card>
    <delete-dialog @closeDialog="delete_dialog=false" :dialog="delete_dialog" title="Discount Offer"></delete-dialog>
    <v-data-table
      :page.sync="page"
    ...
    >
      ...
      <template v-slot:item.action="{ item }">
        <router-link class="profile-link" active-class :exact="true" :to="{name: 'EditDiscount'}">
      ...
      students: [
        {
          ...
          discount: "10 %",
          code: "12345",
          description: "Discount on Student first Registration",
          action: null
        },
        {
