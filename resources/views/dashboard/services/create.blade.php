...
@section('breadcrumbs')
{{ Breadcrumbs::render('service_add') }}
@endsection
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="department_id" id="department_id" class="form-control select2"
                                            required>
                                            <option value="">@lang("service.chooseDepartment")</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="formbuilder_id[]" multiple="multiple" id="formbuilder_id" placeholder="@lang('service.chooseDocument')" class="form-control select2" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="service_detail" id="service_detail" class="form-control"
                                            rows="1"></textarea>
                                    </div>
                                </div>
                            </div>
