...
<div class="container-fluid">
  <div class="fade-in">
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header"><h4>@lang('setting.editMenuElement')</h4></div>
            <div class="card-body">
                ...
                <form action="{{ route('menu.update') }}" method="POST">
                    ...
                    <table class="table table-striped table-bordered datatable">
                        <tbody>
                            <tr class="d-none">
                                <th>
                                @lang('setting.editMenuElement') Menu
                                </th>
                                <td>
                    ...
                    <a class="btn btn-primary" href="{{ route('menu.index', ['menu' => $menuElement->menu_id]) }}">@lang('common.back')</a>
                </form>
            </div>
          </div>
        </div>
