...
@section('breadcrumbs')
{{ Breadcrumbs::render('customer_add') }}
@endsection
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h4>@lang('customer.addCustomer')</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="email" placeholder="@lang('customer.email')" name="email" />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" placeholder="@lang('customer.CNIC')" name="cnic"
                                            required />
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="gender" id="gender" class="form-control" required>
                                            ...
                                            <option value="Male">@lang('customer.Male')</option>
                                            <option value="Female">@lang('customer.Female')</option>
                                            <option value="Other">@lang('customer.Other')</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
