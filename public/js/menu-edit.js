...
this.updateSelectParent = function () {
  axios.get('/admin/menu/element/get-parents?menu=' + document.getElementById("menu").value).then(function (response) {
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\khadamaatek-admin-panel\resources\js\coreui\menu-edit.js */"./resources/js/coreui/menu-edit.js");
